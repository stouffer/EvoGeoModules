...
**Coevolutionary dynamics shape the structure of ecological communities. Reciprocal selection between organisms acts both on species and their interactions. The Geographic Mosaic Theory of Coevolution (GMTC) provides a spatial perspective on these dynamics, by proposing the existence of feedbacks between local and regional scales. Yet it is not clear how the structure of communities at spatial scales relevant to species distribution (e.g. continental) are either influencing or influenced by local coevolutionary process. Here we show that species sorting at the local scale remove community-wide coevolutionary signal, despite having no effect on the coevolutionary significance of individual interactions. That interactions keep their level of coevolutionary significance despite species sorting suggest that they are the right scale to study coevolution at small spatial scales, while whole communities are the relevant scale only for larger spatial extents. Our results provide a new perspective on the integration between coevolutionary theory and community ecology, by providing insights about the organisational scales at which the different theories have relevance.**
