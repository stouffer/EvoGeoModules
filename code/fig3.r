...
boxplot(stat~vary, fig3dat, ylim=rev(c(0,3e4)), lty=1, pch=19, xlab="Interaction spatial consistency", ylab="Interaction-level contribution to coevolutionary signal")
