...
pdf(width=15, file="../figures/figure4.pdf")
par(mfcol=c(1,3), xaxs="i", yaxs="i",pty="s")
...
plot(REG~mreg, allm, pch=NA, col=2, ylab = "Network-level coevolution (relative to continental)", xlab="Average of contributions to coevolution", ylim=c(0, 0.3))
